...
exports.BoopfunConfigCache = void 0;
...
class BoopfunConfigCacheClass {
    constructor() {
        ...
        this.DEFAULT_VIRTUAL_SOL_RESERVES = BigInt('29731395800'); // 29.73 SOL
        this.DEFAULT_VIRTUAL_TOKEN_RESERVES = BigInt('1000000000000000000'); // 1B tokens (9 decimals)
        this.DEFAULT_TOTAL_SUPPLY = BigInt('1000000000000000000'); // 1B tokens (9 decimals)
        this.DEFAULT_GRADUATION_TARGET = BigInt('86000000000'); // 86 SOL
        this.DEFAULT_GRADUATION_FEE = BigInt('6000000000'); // 6 SOL
        this.DEFAULT_DAMPING_TERM = 31;
        this.DEFAULT_SWAP_FEE_BASIS_POINTS = 200; // 2%
        this.DEFAULT_TOKEN_FOR_STAKERS_BASIS_POINTS = 500; // 5%
    }
    /**
     ...
     */
    decodeConfigAccount(configAddress, data) {
        try {
            ...
            const afterOperatorsOffset = OPERATORS_LEN_OFFSET + OPERATORS_LEN_SIZE + operatorsLen * 32;
...
exports.BoopfunConfigCache = new BoopfunConfigCacheClass();
//# sourceMappingURL=boopfun-config-cache.js.map